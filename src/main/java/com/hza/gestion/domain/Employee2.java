 ...
 */
@Schema(description = "The Employee2 entity.")
@Entity
...
public class Employee2 implements Serializable {
    ...
    public Employee2 email(String email) {
        this.setEmail(email);
        return this;
    }
    ...
    public Employee2 phoneNumber(String phoneNumber) {
    ...
    public Employee2 hireDate(Instant hireDate) {
    ...
    public Employee2 salary(Long salary) {
    ...
    public Employee2 commissionPct(Long commissionPct) {
    ...
    public Employee2 jobs(Set<Job> jobs) {
        this.setJobs(jobs);
        return this;
    }

    public Employee2 addJob(Job job) {
        this.jobs.add(job);
        job.setEmployee(this);
        return this;
    }

    public Employee2 removeJob(Job job) {
    ...
    public Employee2 department(Department department) {
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(((Employee2) o).id);
    }
