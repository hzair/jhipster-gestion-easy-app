...
export class VendeurComponent implements OnInit {
  ...
  loadAll(): void {
    ...
    this.vendeurService
      ...
      .subscribe({
        next: (res: HttpResponse<IVendeur[]>) => {
          this.isLoading = false;
          this.paginateVendeurs(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  protected paginateVendeurs(data: IVendeur[] | null, headers: HttpHeaders): void {
